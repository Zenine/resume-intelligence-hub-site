...
See [`docs/ops-decisions.md`](docs/ops-decisions.md) for operational decisions around LLM discovery, IndexNow, link checking, Lighthouse, SVG inlining, and future skill extraction.
