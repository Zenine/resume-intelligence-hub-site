...
The agent will walk you through an 8-question interview:
...
6. **Credential / promotion dossier track?** — enable only if you prepare professional-title, licensure, or promotion packets
7. **Resume output language** — Chinese, English, or both
8. **Repo location** — where on disk
...
Once bootstrapped, the agent handles seven workflows. Invoke with natural language:
...
| Help me prepare a credential / promotion dossier | [Credential / promotion dossier](https://github.com/Zenine/resume-intelligence-hub/blob/main/workflows/credential-application.md) |
