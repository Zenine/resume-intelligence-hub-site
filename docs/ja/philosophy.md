...
反直感的な選択が 11 個。それぞれ失敗から学んだもの。全部理解しなくても使えるが、何かを変えるつもりなら先に読んでほしい。
...
重要な書類では、数字が大きいだけでは足りない。個人の責任、チーム成果、会社全体の指標、見積、パイプライン、予測、確定売上を分けて扱う。ハブはこの境界を保ち、強い主張を説得力があり検証可能なものにする。
